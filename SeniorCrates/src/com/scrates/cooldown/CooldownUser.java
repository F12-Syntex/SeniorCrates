...
public class CooldownUser {
	...
	public Integer getTime(String key) {
		if(this.cooldown.containsKey(key)) {
			...
			int timer = SeniorCrates.getInstance().configManager.cooldown.getCooldown(key);
	...
	public void reset(String key) {
		this.cooldown.put(key, SeniorCrates.getInstance().configManager.cooldown.getCooldown(key));
	}
