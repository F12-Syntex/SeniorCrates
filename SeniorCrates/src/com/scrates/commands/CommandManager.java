...
import com.scrates.config.Permissions;
...
import com.scrates.utils.StringMinipulation;

public class CommandManager implements CommandExecutor {

    private ArrayList<SubCommand> commands = new ArrayList<SubCommand>();
    private Messages messages = SeniorCrates.getInstance().configManager.messages;
    private Permissions permissions = SeniorCrates.getInstance().configManager.permissions;
    private Cooldown cooldowns = SeniorCrates.getInstance().configManager.cooldown;
    
    private SeniorCrates plugin;

    //Sub Commands
    public String main = "crate";
    
    public void setup(SeniorCrates plugin) {
	...
	public SeniorCrates getPlugin() {
		return plugin;
	}


	public void setPlugin(SeniorCrates plugin) {
		this.plugin = plugin;
	}
